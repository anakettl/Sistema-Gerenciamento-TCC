package br.edu.ifrs.poa.sgtcc.security.user.controller;

import br.edu.ifrs.poa.sgtcc.models.Aluno;
import br.edu.ifrs.poa.sgtcc.models.Professor;
import br.edu.ifrs.poa.sgtcc.repositories.AlunoRepository;
import br.edu.ifrs.poa.sgtcc.repositories.ProfessorRepository;
import br.edu.ifrs.poa.sgtcc.repositories.TitulacaoRepository;
import br.edu.ifrs.poa.sgtcc.security.user.*;
import br.edu.ifrs.poa.sgtcc.security.user.repositories.*;
    ...
    public ModelAndView cadastroUsuario(@Valid CadastroDto cadastro, BindingResult resultado, RedirectAttributes redirecionamento) {
        ...
        try {
            ...
            if (cadastro.getCategoria() == Categoria.ALUNO){
                ...
                Aluno aluno = new Aluno(cadastro.getNome(), cadastro.getEmail(), cadastro.getTelefone(), cadastro.getMatricula(), cadastro.getCpf(), null, null, null, null);
                ...
                UsuarioLogado usuario = new UsuarioLogado(cadastro.getUsername(), new BCryptPasswordEncoder().encode(cadastro.getPassword()), papeis);
                Professor professor = new Professor(cadastro.getNome(), cadastro.getEmail(), cadastro.getTelefone(), cadastro.getMatricula(), cadastro.getCpf(), null, null, null, null);
